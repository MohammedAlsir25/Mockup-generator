...
export const ScreenshotInputForm: React.FC<ScreenshotInputFormProps> = ({ files, setFiles, onSubmit, isLoading }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 space-y-6">
        <div>
           <label htmlFor="file-upload-multi" className="block text-sm font-medium text-gray-300 mb-2">
            Upload Screenshots*
          </label>
          <div 
