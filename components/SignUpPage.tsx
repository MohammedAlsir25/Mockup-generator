...
export const SignUpPage: React.FC<SignUpPageProps> = ({ onSignUp, onGoogleLogin, onNavigate }) => {
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
        ...
        {error && <Alert title="Sign Up Failed" message={error} type="error" />}
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          ...
          <button onClick={() => onNavigate('login')} className="font-medium text-indigo-400 hover:underline" disabled={isLoading || isGoogleLoading}>
            Login
          </button>
        </p>
      </div>
